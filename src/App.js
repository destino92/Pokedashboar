...
class App extends Component {
  ...
  handleLimitChange(event) {
    this.setState({
      ...
      // this function runs only once the state has changed.
    ...
    return (
      <div className="App">
        ...
        <PokemonIndexList
          ...
          selectedValue={this.state.limit} allValue={this.state.count} onOptionSelected={this.handleLimitChange}
